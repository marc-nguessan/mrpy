...
import mrpy.discretization.ESDIRK3_2I_4A_2 as IrkScheme
import mrpy.discretization.ERK_ESDIRK3_2I_4A_2 as ErkScheme
...
class Scheme(BaseScheme):
    ...
    #            tree_pressure=tree_pressure)
        ...
        self.irk = IrkScheme.Scheme(tree_velocity_x=tree_velocity_x,
                tree_velocity_y=tree_velocity_y,
                tree_pressure=tree_pressure, tree_vorticity=tree_vorticity,
                tree_scalar=tree_scalar, uniform=uniform, st_flag_vx=st_flag_vx,
                st_flag_vy=st_flag_vy, st_flag_vz=st_flag_vz,
                st_flag_vc=st_flag_vc, st_flag_s=st_flag_s, low_mach=low_mach)
    ...
    def low_mach_update_operators(self, tree_velocity_x, tree_velocity_y, tree_pressure,
        ...
        self.irk.low_mach_update_operators(tree_velocity_x, tree_velocity_y,
                tree_pressure, tree_density)
        #self.erk.low_mach_update_operators(tree_velocity_x, tree_velocity_y,
        #        tree_pressure, tree_density)
    ...
    def advance(self, v_x=None, v_y=None, v_z=None, p=None, t_ini=0, nsp=None,
        ...
        if self.uniform: #v_x, v_y, etc are scalars, and we just advance them
            ...
            g_1f = sd.add_scalars(
                ...
                sd.mul_num_scalar(self.dt, sd.add_scalars(
                    ...
                    sd.mul_num_scalar(self.irk.A_coefs["a44"],
                        ...
                        g_34, st_rhs_14, low_mach_visc_x, one_over_density))))))
            g_2f = sd.add_scalars(
                v_y,
                self.velocity_inverse_mass.apply(
                sd.mul_num_scalar(self.dt, sd.add_scalars(
                    ...
                    sd.mul_num_scalar(self.irk.A_coefs["a44"],
                        ...
                        g_34, st_rhs_24, low_mach_visc_y, one_over_density))))))
            ...
            velocity_x.sc, velocity_y.sc, pressure.sc = g_1f.sc.copy(), g_2f.sc.copy(), g_34.sc.copy()
