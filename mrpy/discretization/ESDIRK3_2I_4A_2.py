...
from mrpy.discretization.ESDIRK4_base import ESDIRK4Scheme
import config as cfg


class Scheme(ESDIRK4Scheme):
    """...
    ...
    def __init__(self, dimension=cfg.dimension, tree_velocity_x=None,
        ...
        ESDIRK4Scheme.__init__(self, dimension=dimension,
    ...
    #        ESDIRK4Scheme.__init__(self, tree_velocity_x=tree_velocity_x, tree_velocity_y=tree_velocity_y, tree_pressure=tree_pressure, tree_vorticity=tree_vorticity)
    #    else:
    #        ESDIRK4Scheme.__init__(self, tree_velocity_x=tree_velocity_x, tree_velocity_y=tree_velocity_y, tree_pressure=tree_pressure)

        self.A_coefs = {"a11":0, "a21":1/2, "a22":1/2, "a31":5/8, "a32":3/8,
                "a33":1/2, "a41":7/18, "a42":1/3, "a43": -2/9, "a44":1/2}
        self.C_coefs = {"c1":0, "c2":1, "c3":3/2, "c4":1}
