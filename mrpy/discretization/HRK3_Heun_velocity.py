...
from mrpy.discretization.HERK3_velocity_base import HERK3Scheme
import config as cfg


class Scheme(HERK3Scheme):
    """...
    ...
    def __init__(self, dimension=cfg.dimension, tree_velocity_x=None,
        ...
        HERK3Scheme.__init__(self, dimension=dimension,
    ...
    #        HERK3Scheme.__init__(self, tree_velocity_x=tree_velocity_x, tree_velocity_y=tree_velocity_y, tree_pressure=tree_pressure, tree_vorticity=tree_vorticity)
    #    else:
    #        HERK3Scheme.__init__(self, tree_velocity_x=tree_velocity_x, tree_velocity_y=tree_velocity_y, tree_pressure=tree_pressure)

        self.A_coefs = {"a21":1./3, "a31":0, "a32":2./3}
        self.B_coefs = {"b1":1./4, "b2":0, "b3":3/4}
        self.C_coefs = {"c1":0, "c2":1./3, "c3":2./3}
