...
class Scheme(ERK4Scheme):
    #!!! c3 = 1, we cannot use the classical theory for 4th order ERK methods!!!
    """...
    ...
    #        ERK4Scheme.__init__(self, tree_velocity_x=tree_velocity_x, tree_velocity_y=tree_velocity_y, tree_pressure=tree_pressure)
        ...
        self.A_coefs["a43"] = 1.
        self.A_coefs["a42"] = 0.
        self.A_coefs["a32"] = (1/6 - \
            self.B_coefs["b4"]*self.A_coefs["a43"]*self.C_coefs["c3"]) / \
        (self.B_coefs["b3"]*self.C_coefs["c2"])
        self.A_coefs["a21"] = self.C_coefs["c2"]
        self.A_coefs["a31"] = self.C_coefs["c3"] - self.A_coefs["a32"]
        self.A_coefs["a41"] = self.C_coefs["c4"] - self.A_coefs["a43"] - self.A_coefs["a42"]
