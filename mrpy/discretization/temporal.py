...
"""This module contains the functions needed to comute the advancement in time
...
# !!!!! WIP !!!!!
    ...
    def uzawa_solver(self, velocity_x=None, velocity_y=None, pressure=None,
                     ...
                     rtol=1e-10, atol=1e-10, preconditioner="Chorin-Temam",
                     right_rhs=False):
        ...
        #global_rhs[n_vx + n_vy:] = new_rhs_momentum_y
    ...
    def advance(self, tree_velocity_x=None, tree_velocity_y=None,
                tree_velocity_z=None, tree_pressure=None,
                tree_source_term_velocity_x=None,
                tree_source_term_velocity_y=None,
                tree_source_term_velocity_z=None, t_ini=0, nsp=None):
...
class ImplicitExplicitEulerScheme(BaseScheme):
    ...
    def make_rhs_momentum_x(self, velocity_x, velocity_y,
                            source_term_velocity_x, source_term_velocity_y):

        return sd.add_scalars(
            sd.mul_num_scalar(1/self.dt, self.velocity_mass.apply(velocity_x)),
            #self.velocity_mass.apply(source_term_velocity_x))
            self.velocity_mass.apply(source_term_velocity_x),
            sd.mul_num_scalar(-1., self.velocity_adv_x.apply(self.dimension, velocity_x, velocity_x, velocity_y)))

    def make_rhs_momentum_y(self, velocity_x, velocity_y,
                            source_term_velocity_x, source_term_velocity_y):

        return sd.add_scalars(
            sd.mul_num_scalar(1/self.dt, self.velocity_mass.apply(velocity_y)),
            #self.velocity_mass.apply(source_term_velocity_y))
            self.velocity_mass.apply(source_term_velocity_y),
            sd.mul_num_scalar(-1., self.velocity_adv_y.apply(self.dimension, velocity_y, velocity_x, velocity_y)))

    def make_rhs_stokes_equation(self, velocity_x, velocity_y, source_term_velocity_x, source_term_velocity_y):
    ...
    def make_ksps(self, preconditioner="Chorin-Temam"):
        ...
        if preconditioner == "Chorin-Temam":
            ...
            #ksp_pc.setOperators(pc.matrix, self.velocity_lap_x.matrix)
            self.ksp_pc.setOperators(self.pc.matrix)
            #ksp_pc.setType("bcgs")
            #ksp_pc.getPC().setType("lu")
            #ksp_pc.setTolerances(max_it=5000)

            nsp = petsc.NullSpace().create(constant=True)
            self.pc.matrix.setNullSpace(nsp)

            self.ksp_pc.setTolerances(rtol=1.e-10)
    ...
    def advance(self, tree_velocity_x, tree_velocity_y, tree_pressure,
        ...
        source_term_velocity_x = sd.Scalar(tree_source_term_velocity_x)
        source_term_velocity_y = sd.Scalar(tree_source_term_velocity_y)
    ...
    def advance_given_scalar(self, velocity_x, velocity_y, pressure,
                source_term_velocity_x, source_term_velocity_y,
                t_ini=0, nsp=None):
...
class ImplicitRungeKuttaStage2Scheme(BaseScheme):
    ...
    def __init__(self, dimension=cfg.dimension, tree_velocity_x=None,
        ...
        self.approx_solver_1 = ImplicitExplicitEulerScheme(tree_velocity_x=tree_velocity_x, tree_velocity_y=tree_velocity_y, tree_pressure=tree_pressure)
        self.approx_solver_2 = ImplicitExplicitEulerScheme(tree_velocity_x=tree_velocity_x, tree_velocity_y=tree_velocity_y, tree_pressure=tree_pressure)
    ...
    def nonlin_op_apply(self, x1, y1, z1, x2, y2, z2):
        ...
        temp_adv_x_1 = self.velocity_adv_x.apply(self.dimension, x1, x1, y1).sc
        temp_adv_x_1 -= self.velocity_adv_x.bc_x
        temp_adv_x_1 -= self.velocity_adv_x.bc_y

        temp_adv_x_2 = self.velocity_adv_x.apply(self.dimension, x2, x2, y2).sc
        temp_adv_x_2 -= self.velocity_adv_x.bc_x
        temp_adv_x_2 -= self.velocity_adv_x.bc_y

        temp_adv_y_1 = self.velocity_adv_y.apply(self.dimension, y1, x1, y1).sc
        temp_adv_y_1 -= self.velocity_adv_y.bc_x
        temp_adv_y_1 -= self.velocity_adv_y.bc_y

        temp_adv_y_2 = self.velocity_adv_y.apply(self.dimension, y2, x2, y2).sc
    ...
    def rhs_1(self, x, y, z, tree_source_term_velocity_x, t=0.):
        """...
        ...
        self.compute_source_term(tree_source_term_velocity_x, self.stfv_x, t)
        temp_1 = sd.Scalar(tree_source_term_velocity_x)
        temp_1 = self.velocity_mass.apply(temp_1)
        result.sc += temp_1.sc

        return result

    def rhs_2(self, x, y, z, tree_source_term_velocity_y, t=0.):
        """...
        ...
        self.compute_source_term(tree_source_term_velocity_y, self.stfv_y, t)
        temp_1 = sd.Scalar(tree_source_term_velocity_y)
        temp_1 = self.velocity_mass.apply(temp_1)
        result.sc += temp_1.sc
    ...
    def rhs_newton_iteration(self, velocity_x, velocity_y,
            tree_source_term_velocity_x, tree_source_term_velocity_y, t_ini, x1, y1, z1, x2, y2, z2):
        """...
        ...
        temp = sd.add_scalars(
            ...
            sd.mul_num_scalar(self.A_coefs["a11"], self.rhs_1(x1, y1, z1,
                tree_source_term_velocity_x, t_ini + self.C_coefs["c1"]*self.dt)),
            ...
            sd.mul_num_scalar(self.A_coefs["a12"], self.rhs_1(x2, y2, z2,
                tree_source_term_velocity_x, t_ini
        ...
        temp = sd.add_scalars(
            ...
            sd.mul_num_scalar(self.A_coefs["a11"], self.rhs_2(x1, y1, z1,
                tree_source_term_velocity_y, t_ini
                + self.C_coefs["c1"]*self.dt)),
        ...
        global_rhs_2[:self.n_mesh_p] = temp.sc
    ...
    def rhs_1_pic_fullexp(self, tree_source_term_velocity_x, t=0.):
        """...
    ...
    def rhs_2_pic_fullexp(self, tree_source_term_velocity_y, t=0.):
        """...
    ...
    def nonlin_rhs_pic_fullexp(self, velocity_x, velocity_y,
            tree_source_term_velocity_x, tree_source_term_velocity_y, t_ini):
        ...
        temp = sd.add_scalars(
            ...
            sd.mul_num_scalar(self.A_coefs["a11"], self.rhs_2_pic_fullexp(
                tree_source_term_velocity_y, t_ini + self.C_coefs["c1"]*self.dt)),
        ...
        result[2*self.n_mesh_vx + 2*self.n_mesh_vy:2*self.n_mesh_vx +
                2*self.n_mesh_vy + self.n_mesh_p] = self.rhs_3_pic_fullexp().sc
        result[2*self.n_mesh_vx + 2*self.n_mesh_vy + self.n_mesh_p:] = \
            self.rhs_3_pic_fullexp().sc

        return result

    def rhs_pic_fullexp_iteration(self, velocity_x, velocity_y,
            tree_source_term_velocity_x, tree_source_term_velocity_y, t_ini, x1,
            y1, x2, y2):
        """...
        ...
        iter_rhs_3[:self.n_mesh_p] = self.rhs_3_pic_fullexp().sc
        iter_rhs_3[self.n_mesh_p:] = self.rhs_3_pic_fullexp().sc
    ...
    def Newton_init_val(self, tree_velocity_x, tree_velocity_y, tree_pressure,
            source_term_velocity_x, source_term_velocity_y):
        """...

        """

        self.approx_vx_1 = sd.Scalar(tree_velocity_x)
        self.approx_vx_2 = sd.Scalar(tree_velocity_x)
        self.approx_vy_1 = sd.Scalar(tree_velocity_y)
        self.approx_vy_2 = sd.Scalar(tree_velocity_y)
        self.approx_p_1 = sd.Scalar(tree_pressure)
        self.approx_p_2 = sd.Scalar(tree_pressure)
        ...
        #        self.approx_p_1, source_term_velocity_x, source_term_velocity_y)
        #self.approx_solver_2.advance_given_scalar(self.approx_vx_2, self.approx_vy_2,
        #        self.approx_p_2, source_term_velocity_x, source_term_velocity_y)
    ...
    def Newton_solver(self, velocity_x, velocity_y, pressure,
            tree_source_term_velocity_x, tree_source_term_velocity_y, t_ini,
                      max_it=1, rtol=1e-06):
        """Inspired by the implementation of Implicit Runge-Kutta methdos of
        ...
        #while (count < max_it):
            ...
            if count == 0:
                global_rhs_1, global_rhs_2 = self.rhs_newton_iteration(velocity_x,
                        velocity_y, tree_source_term_velocity_x,
                        tree_source_term_velocity_y, t_ini, x1, y1, z1, x2, y2, z2)
    ...
    def Nonlin_init_val(self, tree_velocity_x, tree_velocity_y, tree_pressure,
            source_term_velocity_x, source_term_velocity_y):
        """...
        ...
        #while (count < max_it):
            ...
            iter_rhs_1, iter_rhs_2, iter_rhs_3 = \
                self.rhs_pic_fullexp_iteration(velocity_x,
                    velocity_y, tree_source_term_velocity_x,
                    tree_source_term_velocity_y, t_ini, x1, y1, x2, y2)
...
class RadauIIAStage2Scheme(ImplicitRungeKuttaStage2Scheme):
    """...
    ...
    def advance(self, tree_velocity_x, tree_velocity_y, tree_pressure,
        ...
        if self.nonlin_solver == "newton":
            self.Newton_init_val(tree_velocity_x, tree_velocity_y, tree_pressure,
                source_term_velocity_x, source_term_velocity_y)
            self.Newton_solver(velocity_x, velocity_y, pressure,
                    tree_source_term_velocity_x, tree_source_term_velocity_y, t_ini)
        elif self.nonlin_solver == "pic_fullexp":
            self.Nonlin_init_val(tree_velocity_x, tree_velocity_y, tree_pressure,
                source_term_velocity_x, source_term_velocity_y)
        ...
        pressure.sc = self.solve(self.pressure_divgrad,
            ...
            source_term_velocity_x, source_term_velocity_y), nsp).sc
