...
from mrpy.discretization.ERK_velocity_base import ERKScheme
import config as cfg


class ERK4Scheme(ERKScheme):
    """Base scheme for the implementation of 4-stage Explicit Runge-Kutta
    ...
    def __init__(self, dimension=cfg.dimension, tree_velocity_x=None,
        ...
        ERKScheme.__init__(self, dimension=dimension,
    ...
    #        ERKScheme.__init__(self, tree_velocity_x=tree_velocity_x,
    ...
    def advance(self, v_x=None, v_y=None, v_z=None, p=None, t_ini=0, nsp=None):
        ...
        if self.uniform: #v_x, v_y, etc are scalars, and we just advance them
            ...
            v_x.sc, v_y.sc = g_1final.sc.copy(), g_2final.sc.copy()
            ...
            velocity_x.sc, velocity_y.sc = g_1final.sc.copy(), g_2final.sc.copy()
