...
#writer = output_module.OutputWriter("manufactured_solution")
#writer.initialize()
...
print("2D manufactured solution")
...
#============================= Printing solutions ==============================
        if t >= t_print:
            ...
            writer.write([tree_velocity_x, tree_velocity_y, tree_pressure],
                    output_file_name="manufactured_solution_t_" + repr(it).zfill(5),
                    time=t)
...
timesteps = [20, 30, 40, 50, 70, 100, 120]
