...
def omega(x, y, t=0.):
    ...
    #return 0.5*F_1*(1 + tanh(200*(0.03 - sqrt((x - x_1)**2 + (y - y_1)**2)))) + \
    #       0.5*F_2*(1 + tanh(200*(0.03 - sqrt((x - x_2)**2 + (y - y_2)**2)))) + \
    #       0.5*F_3*(1 + tanh(200*(0.03 - sqrt((x - x_3)**2 + (y - y_3)**2)))) + \
    #       0.5*F_4*(1 + tanh(200*(0.03 - sqrt((x - x_4)**2 + (y - y_4)**2))))
